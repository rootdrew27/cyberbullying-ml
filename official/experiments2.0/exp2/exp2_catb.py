...
if __name__ == '__main__':
    try:
        ...
        test_df['Code'] = test_df['Code'].apply(lambda label: 0 if label == 'N' else 1)
        ...
        y_test = test_df['Code']
        catb_param_results:pd.DataFrame = params.get_topn_param_sets(PARAMS_PATH, algo='catb', dataset='d1', n=10, sort_condition='f1_macro_mean')
