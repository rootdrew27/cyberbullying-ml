...
if __name__ == '__main__':
    try:
        ...
        test_df['class'] = test_df['class'].apply(lambda label: 0 if label == 2 else 1)
        ...
        xgb_param_results:pd.DataFrame = get_topn_param_sets(PARAMS_PATH, algo='xgb', dataset='d1', n=10, sort_condition='f1_macro_mean')
